package com.l_github.derlio.waveform;
...
public class SimpleWaveformView extends View {
    ...
    private void initFromAttributes(AttributeSet attrs) {
        ...
        mWaveformColor = a.getColor(R.styleable.SimpleWaveformView_waveformColor,  R.color.default_camWaveform);

        mPlaybackIndicatorColor = a.getColor(R.styleable.SimpleWaveformView_indicatorColor,  R.color.default_playback_indicator);
    ...
    public void setPlaybackPosition(int position) {
        ...
        mPlaybackIndicatorPosition = (int) (frame / (float) mNumFrames * getMeasuredWidth());
        invalidate();
    }
    ...
    private void computeDoublesForAllZoomLevels() {
        ...
        Log.i("bobopro", Double.toString(minGain)+", "+ Double.toString(maxGain));

        // Compute the heights

        // 2020년 12월 10일 Level 보정
        maxGain = 210;
        minGain = 20;
