 ...
 * Video Adapter
 */
class ImageListAdapter(val fileList:MutableList<FileData>, val context: Context, private val listener: ItemDragListener) : RecyclerView.Adapter<ImageListAdapter.ViewHolder>(), ItemActionListener {
...
//        }
        ...
        // 파일 패스
        Glide.with(context).load(File(list[position].filePath)).into(holder.imageView)
