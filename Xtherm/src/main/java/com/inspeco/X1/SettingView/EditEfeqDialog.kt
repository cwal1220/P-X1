...
import kotlinx.android.synthetic.main.d_efeq_edit.*
import kotlinx.android.synthetic.main.d_efeq_edit.itemEdit
import kotlinx.android.synthetic.main.d_efeq_edit.saveButton
 ...
 * Edit e 주파수 다이얼로그
 */
class EditEfeqDialog(context: Context, var percent: Int) : Dialog(context) {
    private val TAG = "bobopro- 주파수 Edit Dialog"
    ...
    init {
        ...
        setCancelable(true)
        setContentView(R.layout.d_efeq_edit)

        var sPer = percent.toString()

        itemEdit.filters = arrayOf<InputFilter>(InputFilterMinMax("0", "150"))
