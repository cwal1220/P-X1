...
public class WebCam {
	...
	private static final String TAG = WebCam.class.getSimpleName();
	...
	static {
		if (!isLoaded) {
			...
			System.loadLibrary("usb1002");
			System.loadLibrary("uvc2");
			System.loadLibrary("UVCCamera2");
			isLoaded = true;
		}
	}

	private com.serenegiant.usb.USBMonitor.UsbControlBlock mCtrlBlock;
     ...
     * @param ctrlBlock
     */
    public synchronized void open(final com.serenegiant.usb.USBMonitor.UsbControlBlock ctrlBlock) {
    	int result;
    	try {
...
//    		mNativePtr = 0;	// nativeDestroyを呼ぶのでここでクリアしちゃダメ
	...
	public com.serenegiant.usb.USBMonitor.UsbControlBlock getUsbControlBlock() {
		return mCtrlBlock;
	}
...
//================================================================================
	...
	private final String getUSBFSName(final com.serenegiant.usb.USBMonitor.UsbControlBlock ctrlBlock) {
		String result = null;
